...
**🟥 Iced-Latte (Backend)** is a non-profit sandbox project where a team of IT enthusiasts are working on creating a modern marketplace (https://il.pride.improwised.dev/) for selling coffee in order to pump up their soft and hard skills and have fun working on an interesting project.
...
Swagger REST APIs contracts described [here](https://il.pride.improwised.dev/backend/api/docs/swagger-ui/index.html).
